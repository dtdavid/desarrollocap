...
function EditarPerfil() {
 ...
 const handleImageUpload = (event) => {
  ...
  useEffect(() => {
    ...
    const cursosGuardados = JSON.parse(localStorage.getItem("listaCursos")) || [];
    ...
    <div className="flex justify-center items-center min-h-dvh bg-azul-claro px-4">
      <div className="flex flex-col md:flex-row items-center gap-6">
        <div className="flex flex-col items-center justify-center">
            <img src={selectImage || ImagenPerfil} alt="foto de perfil" className="w-80 h40 object-cover rounded-full border-4 border-white shadow-lg"/> 
  ...
  />
      ...
      >
        <h2 className="text-xl font-semibold mb-4 text-center">EDITAR PERFIL</h2>
...
<div className="flex items-center mb-3 border rounded bg-gray-100 p-2">
    < FaInstagram className="text-gray-500 mr-2" size={30} />
        ...
        <label className="text-sm font-semibold mb-1 block">Cursos inscritos:</label>
  ...
  {cursos.length > 0 ? (
    ...
    <li className="italic text-gray-500">No hay cursos registrados.</li>
  )}
</ul>
